package com.microteam.poi.excel;
...
public class ExcelUtilityUnitTest {
    private static final String FILE_NAME = "src/main/resources/food_info.xlsx";
    ...
    public void givenStringPath_whenReadExcel_thenThrowException() {
        assertThrows(IOException.class, () -> {
            ExcelUtility.readExcel("src/main/resources/food_info.xlsx");
        });
    }
