package com.microteam.expandcolumn;
...
class ExpandColumnUnitTest {
    ...
    void whenSetColumnWidth_thenColumnSetToTheSpecifiedWidth() {
        ...
        // Replaced assertThat with assertEquals
    ...
    void whenAutoSizeColumn_thenColumnExpands() {
        ...
        // Replaced assertThat with assertTrue
        assertTrue(sheet.getColumnWidth(0) > originalWidth, "Column width should expand after auto-sizing.");
    }
